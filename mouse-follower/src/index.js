...
/*
Edited package using this method:
https://stackoverflow.com/a/62567471/12988774
*/
    ...
    bind() {
        ...
        this.event.mousemove = (e) => {
            this.gsap.to(this.pos, {
                x: this.stick
                    ? this.stick.x -
                      (this.stick.x - e.clientX) * this.options.stickDelta
                    : e.clientX,
                y: this.stick
                    ? this.stick.y -
                      (this.stick.y - e.clientY) * this.options.stickDelta
                    : e.clientY,
